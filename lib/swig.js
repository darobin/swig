...
exports.Swig = function (opts) {
  ...
  this.compile = function (source, options) {
    ...
    code = parser.compile(tokens, parent, options);

    function compiled(context) {
      var tpl = new Function('_swig', '_ctx', '_filters', '_', '_fn', [
        'with (_ctx) {',
        '  var _output = "";',
        code,
        '  return _output;',
      ...
      return tpl(self, _.extend({}, locals, context || {}), filters, _, function () { return ''; });
    }
